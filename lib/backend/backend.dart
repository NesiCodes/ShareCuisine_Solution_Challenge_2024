...
import 'schema/requested_packages_record.dart';
...
export 'schema/requested_packages_record.dart';
...
/// Functions to query RequestedPackagesRecords (as a Stream and as a Future).
Future<int> queryRequestedPackagesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RequestedPackagesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RequestedPackagesRecord>> queryRequestedPackagesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RequestedPackagesRecord.collection,
      RequestedPackagesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RequestedPackagesRecord>> queryRequestedPackagesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
