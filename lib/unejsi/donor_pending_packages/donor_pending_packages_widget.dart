...
import 'donor_pending_packages_model.dart';
export 'donor_pending_packages_model.dart';

class DonorPendingPackagesWidget extends StatefulWidget {
  const DonorPendingPackagesWidget({super.key});

  @override
  State<DonorPendingPackagesWidget> createState() =>
      _DonorPendingPackagesWidgetState();
}

class _DonorPendingPackagesWidgetState
    extends State<DonorPendingPackagesWidget> {
  late DonorPendingPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DonorPendingPackagesModel());
  }
    ...
    return StreamBuilder<List<RequestedPackagesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RequestedPackagesRecord>
            donorPendingPackagesRequestedPackagesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final donorPendingPackagesRequestedPackagesRecord =
            donorPendingPackagesRequestedPackagesRecordList.isNotEmpty
                ? donorPendingPackagesRequestedPackagesRecordList.first
                : null;
