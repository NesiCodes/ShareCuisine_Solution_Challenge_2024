...
import 'searchf_model.dart';
export 'searchf_model.dart';

class SearchfWidget extends StatefulWidget {
  const SearchfWidget({super.key});

  @override
  State<SearchfWidget> createState() => _SearchfWidgetState();
}

class _SearchfWidgetState extends State<SearchfWidget> {
  late SearchfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchfModel());
