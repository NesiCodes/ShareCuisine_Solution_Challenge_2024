...
class _FeedbackWidgetState extends State<FeedbackWidget> {
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(text: 'Reason');
                ...
                child: StreamBuilder<List<UserNotificationsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<UserNotificationsRecord>
                        columnUserNotificationsRecordList = snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final columnUserNotificationsRecord =
                        columnUserNotificationsRecordList.isNotEmpty
                            ? columnUserNotificationsRecordList.first
                            : null;
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await UserNotificationsRecord.collection
                                  .doc()
                                  .set(createUserNotificationsRecordData(
                                    userId: widget.userId,
                                    date: getCurrentTimestamp.toString(),
                                    donorName: columnUserNotificationsRecord
                                        ?.donorName,
                                    message: _model.textController.text,
                                    feedback: 'Refusal',
                                  ));
                              await widget.requestReference!.delete();
                              context.safePop();
                            },
                            text: 'SEND',
